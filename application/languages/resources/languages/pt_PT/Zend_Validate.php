...
return array(
    ...
    "The two given tokens do not match" => "Os dois valores fornecidos não combinam",
    ...
    // RPS_Validate_Users_Forms_Oldpassword
    "Invalid current password" => "A palavra-passe actual não está correcta",
    
    // Zend_Validate_Captcha
    "Captcha value is wrong" => "'%value%' não correspondeu ao texto apresentado",
    "Empty captcha value"    => "O valor é obrigatório e não pode estar vazio",
);
